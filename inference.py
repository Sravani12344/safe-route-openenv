...
def setup_openai_client():
    # Strictly follow the Hackathon instruction: base_url=os.environ["API_BASE_URL"] and api_key=os.environ["API_KEY"]
    ...
    # Local fallback for your testing only
    api_key = os.environ.get("HF_TOKEN", "dummy_key_for_testing")
